...
export default function PrivacyPolicyPage() {
  return (
    <html lang="en">
      <head>
        <title>Privacy Policy | Zenith Digital Solution</title>
        <meta name="description" content="Read the privacy policy for Zenith Digital Solution. Learn how we collect, use, and protect your information when you use our website and services." />
      </head>
      <body style={{ fontFamily: 'sans-serif', background: '#f9fafb', color: '#222', margin: 0 }}>
        <main style={{ maxWidth: 700, margin: '0 auto', padding: '3rem 1rem' }}>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <p>
              If you have any questions about this Privacy Policy, please contact us at <a href="mailto:hello@zenithdigital.com">hello@zenithdigital.com</a>.
            </p>
          </section>
        </main>
      </body>
